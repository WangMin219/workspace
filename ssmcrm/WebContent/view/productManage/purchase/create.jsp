    ...
    <div class="container-fluid main-content">
        <div class="widget-container fluid-height clearfix">
            <div class="heading clearfix">
                <i class="icon-reorder"></i> 新增采购单 <a href="javascript:;" class="pull-right"
                                                      onclick="history.go(-1);"><i class="icon-reply"></i></a>
            </div>
            <div class="widget-content padded clearfix">
                <form id="billForm" class="form-horizontal" action="view/productManage/purchase/index.jsp" method="get">
                    <div class="form-body">
                            ...
                            <tr>
                                <td class="form-inline">
                                    ...
                                    <input type="text" id="w0" class="form-control form_datetime"
                                           name="send_date" value="2017-03-29" readonly style="width:170px;">
                            ...
                            <div class="span12">
                                <table class="table table-bordered" id="no-input-border" width="95%" border="0"
                                    ...
                                    <tr id="row_1">
                                        ...
                                        <td>
                                            <input type="text" name="product[1][unit_price]"
                                                   id="product_unit_price_1" onkeyup="product_calculate(1)"
                                                   class="form-control">
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <input type="text" name="product[1][tax_rate]"
                                                   id="product_tax_rate_1" onkeyup="product_calculate(1)"
                                                   class="form-control">
                                        </td>
                                        <td>
                                            <input type="text" id="product_tax_price_1"
                                    ...
                                    <tr>
                                        <td style="text-align:center;" colspan="13">
                                            <input id="submitForm" class="btn btn-success" type="submit"
                                                   value="保存">&nbsp;
